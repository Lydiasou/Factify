...
//         <Flash type="success" message="Yay! 🎉 Merci pour votre signalement ! Vous avez gagné 0,01 ETH." />
//         <Flash type="danger" message="Oops! 😱 Erreur dans votre signalement. Vous avez perdu 0,01 ETH." />
